...
```
root@16ef1481fce1:/home/bl0ody_mary# ls -al
total 68
...
Note the file  `De\ Monne\ Customer\ Portal.pdf`

Then we use: `base64 De\ Monne\ Customer\ Portal.pdf`
...
On youe local machine paste the b64 string into a file and save as `encoded`

Then run `base64 -d encoded > file.pdf`

Open the resulting pdf file in your favourite PDF viewer to see the flag;

![image](https://user-images.githubusercontent.com/73170900/137818406-c4c83588-6ad9-4a7d-97d1-2d909eb86a32.png)
